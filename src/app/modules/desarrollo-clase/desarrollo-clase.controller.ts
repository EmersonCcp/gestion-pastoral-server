...
export class DesarrolloClaseController {
  ...
  @Post()
  @RequirePermissions(['desarrollo_clase.create', 'desarrollo_clase.*'])
  ...
  @Get()
  @RequirePermissions(['desarrollo_clase.read', 'desarrollo_clase.*'])
  ...
  @Delete(':id')
  @RequirePermissions(['desarrollo_clase.delete', 'desarrollo_clase.*'])
